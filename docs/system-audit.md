...
Buncombe County logging standards requires application and system logs to contain
...
All systems and software developed at Buncombe County must have the following security
...
5. All Buncombe County IT infrastructure must have system clock synchronized
...
Buncombe County's Security Officer is authorized to select and use assessment tools
that are designed to detect vulnerabilities and intrusions. Use of such tools
against Buncombe County systems and environments are prohibited by others, including
