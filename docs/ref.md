...
This is an abridged version of Buncombe County's security policy that all
...
* First and foremost, as a Health IT provider, Buncombe County and all
...
!!! check "Acknowledgement"
    ...
    As a Buncombe County employee, I acknowledge that
...
[1]: http://buncombecounty.org/security
...
(j) Mobile devices are not allowed to connect directly to Buncombe County production
environments.
...
Buncombe County file sharing / team site (e.g. SharePoint). Examples of
...
* (preferred) “Report a security incident” by creating an issue on
  ...
  [internal help desk](](mailto:security@buncombecounty.org)

* For non-sensitive, non-confidential security issues and concerns, employees
  may post questions on Buncombe County’s #infosec Slack channel.
...
Software approved for use at Buncombe County includes, but is not limited to:
...
**How to contact us**                                   | You can contact us using the Contact Us page on our Sites or by mail at 200 College Street, Suite 300. <br /><br />If you have questions, suggestions, or concerns about this policy, or about our use of your information, including filing a complaint, please contact our Data Protection Officer or Privacy Officer at privacy@buncombecounty.org.
...
**PAYMENT AND CARD INFORMATION.** Some Buncombe County Services
...
* In accordance with regulatory requirements, we may de-identify, store and use
  ...
  development. This is important for Buncombe County to maintain high
...
please contact our Data Protection Officer at privacy@buncombecounty.org,
...
## Buncombe County HIPAA Business Associate Agreement ("BAA")
...
between Buncombe County Government ("Company") and the Supplier named on the signature page
...
## HIPAA Mappings to Buncombe County Policies and Controls

`2022.1`

Below is a list of HIPAA Safeguards and Requirements and the
Buncombe County policies and controls in place to meet those.

HIPAA **Administrative Controls**                     | Buncombe County Policies and Controls
---                                                   | ---
...
HIPAA **Physical Safeguards**                         | Buncombe County Policies and Controls
---                                                   | ---
...
HIPAA **Technical Safeguards**                        | Buncombe County Policies and Controls
---                                                   | ---
...
HIPAA **Organizational Requirements**                 | Buncombe County Policies and Controls
---                                                   | ---
Business Associate Contracts or Other Arrangements - 164.314(a)(1)(i) | Business Associate Agreements; Vendor Management

HIPAA **Policies and Procedures and Documentation Requirements** | Buncombe County Policies and Controls
---                                                   | ---
Policies and Procedures - 164.316(a)                  | Policy Management
Documentation - 164.316(b)(1)(i)                      | Policy Management

**HITECH Act - Security Provisions**                  | Buncombe County Policies and Controls
---                                                   | ---
...
## NIST Mappings to Buncombe County Policies and Controls

`2022.1`

Below is a list of NIST SP 800-53 Controls Families and the mappings to
Buncombe County policies and controls in place.

ID | NIST SP 800-53 Control Family          | Buncombe County Policies and Controls
-- | ---                                    | ---
