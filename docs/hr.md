...
Buncombe County uses  to manage its workforce personnel records.
...
Buncombe County publishes job descriptions for available positions and
...
3. Security will terminate users' access rights immediately upon notification,
   and will coordinate with the appropriate Buncombe County employees to terminate
...
Buncombe County workforce members are to escalate issues using the
...
Buncombe County's incident response procedures; if you are unsure whether
...
The Buncombe County requires all workforce members to observe high
...
to report serious concerns so that Buncombe County can address and correct
...
Buncombe County encourages employees to go above and beyond to contribute
...
Workforce members shall report non-compliance of Buncombe County's policies and
...
1. The Security Officer promptly facilitates a thorough investigation of all
   reported violations of Buncombe County's security policies and procedures. The
    ...
    * Provide individuals suspected of non-compliance of the Security rule
      and/or Buncombe County's policies and procedures the opportunity to explain their
      actions.
...
2. Violation of any security policy or procedure by workforce members may result
    ...
    * Buncombe County reserves the right to terminate employees in the case of serious
      cases of misconduct.
    * A violation resulting in a breach of confidentiality (i.e. release of
      ...
      termination of the workforce member from Buncombe County.
...
4. In the case of an insider threat, the Security Officer and Privacy Officer
   ...
   malicious activity. Buncombe County workforce members are encouraged to come forward
