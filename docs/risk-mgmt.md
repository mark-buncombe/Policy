...
Buncombe County has established formal risk analysis and risk management
processes to
...
Buncombe County's corporate compliance and information security program.

Buncombe County's risk management process is developed in accordance with
...
Risk assessments are done throughout product life cycles:
  ...
  * Before the integration of new system technologies and before changes are
    made to Buncombe County physical and technical safeguards; and (Note that these
    ...
    Buncombe County Platform)
  * While making changes to Buncombe County physical equipment and facilities that
    introduce new, untested configurations.

Buncombe County performs periodic technical and non-technical assessments of the
...
Buncombe County implements security measures sufficient to reduce risks and
vulnerabilities to a reasonable and appropriate level to:
  ...
  1. Ensure the confidentiality, integrity, and availability of all sensitive data
     Buncombe County receives, maintains, processes, and/or transmits for its
     Customers;
...
In addition, Buncombe County risk management process requires that:

1. Any risk remaining (residual) after other risk controls have been applied,
   requires sign off by the senior management and Buncombe County's Security Officer.
2. All Buncombe County workforce members are expected to fully cooperate with all
   ...
   outlined in the Buncombe County Roles Policy.
3. The implementation, execution, and maintenance of the information security
   risk analysis and risk management process is the responsibility of Buncombe County's
...
ensure the continued adequacy and continuous improvement of Buncombe County's
information security program:

* Scheduled Basis - an overall risk assessment of Buncombe County's information system
...
* As Needed - the Security Officer (or other designated employee) or Risk
  ...
  affect Buncombe County's Platform.
...
* Step 1. System Characterization
    ...
    * The first step in assessing risk is to define the scope of the effort. To
      ...
      transmitted. Using information-gathering techniques, the Buncombe County Platform
      boundaries are identified.

    * Output - Characterization of the Buncombe County Platform system assessed, a good
...
* Step 4. Control Analysis
    ...
    * Document and assess the effectiveness of technical and non-technical
      controls that have been or will be implemented by Buncombe County to minimize or
...
* Step 6. Impact Analysis
    ...
    * Determine the level of adverse impact that would result from a threat
      ...
      to consider should include the importance to Buncombe County's mission;
...
Buncombe County Security team maintains a registry of risks, captured and kept updated
