...
Buncombe County IT leverages a SaaS-based IT asset management system,
...
Buncombe County IT manager is responsible for ensuring each physical asset is applied
with a Buncombe County property tag, and an up-to-date record is maintained in the IT
