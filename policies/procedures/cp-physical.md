...
* Enforcement of Facility Access Policies
    ...
    * Visitors in violation of this policy are subject to loss of vendor
      privileges and/or termination of services from Buncombe County.
...
* Workstation Security
    ...
    * All workstations purchased by Buncombe County are the property of Buncombe County and
...
* **Indianapolis, IN** Office
    ...
    * The main entry to our office suite is open during normal business hours
      (M-F 8am-5pm)
    * Buncombe County office space is secured and requires an access card for entry for
      after hours access
...
* **Morrisville, NC** Office
    ...
    * After hours the building is secured and requires an access card for entry
    * Buncombe County office suite is secured 24/7 and requires an access card for
      entry
...
the physical security folder located on the Buncombe County SharePoint site.
